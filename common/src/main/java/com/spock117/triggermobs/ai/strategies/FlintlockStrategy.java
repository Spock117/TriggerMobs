...
/**
 * AI strategy for Flintlock weapons.
 * Characteristics: Single shot, slow reload, can dual wield, medium range.
 */
public class FlintlockStrategy implements WeaponAIStrategy {
        ...
        if (hasAmmo && canReload) {
            ...
            if (isInRange && seeTime >= 5) {
                ...
                if (distance < MIN_DISTANCE) {
                    ...
                    forwardSpeed = STRAFE_SPEED; // Move forward if too far
                } else {
                    forwardSpeed = 0.0F; // Maintain position
                }
    ...
    public void shoot(PathfinderMob mob, LivingEntity target, InteractionHand hand, ItemStack weapon) {
        ...
        GunAiDebug.handleShoot(msg, mob, weapon, "Flintlock");
    ...
    public boolean canDualWield() {
        return true; // Flintlock can be dual wielded
    }
