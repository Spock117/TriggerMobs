...
/**
 * AI strategy for Nailgun weapons.
 * Characteristics: High capacity (40), fast fire rate, sustained fire, medium range.
 */
public class NailgunStrategy implements WeaponAIStrategy {
    ...
    public boolean canDualWield() {
        return false; // Nailgun is two-handed
    }
