...
/**
 * AI strategy for Revolver weapons.
 * Characteristics: 6 shots, medium reload, can dual wield, medium range.
 */
public class RevolverStrategy implements WeaponAIStrategy {
    ...
    public void shoot(PathfinderMob mob, LivingEntity target, InteractionHand hand, ItemStack weapon) {
        ...
        GunAiDebug.handleShoot(msg, mob, weapon, "Revolver");
    ...
    public boolean canDualWield() {
        return true; // Revolver can be dual wielded
    }
