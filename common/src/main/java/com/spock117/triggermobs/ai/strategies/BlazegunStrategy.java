...
/**
 * AI strategy for Blazegun weapons.
 * Characteristics: Fuel-based (very high capacity), continuous fire, close-medium range.
 */
public class BlazegunStrategy implements WeaponAIStrategy {
    public static final UniformInt PATHFINDING_DELAY_RANGE = TimeUtil.rangeOfSeconds(1, 2);
    private static final float IDEAL_DISTANCE = 8.0F;
    ...
    public void move(PathfinderMob mob, LivingEntity target, double distance, double distanceSqr,
        ...
        if (hasAmmo && canReload) {
            ...
            if (isInRange && seeTime >= 5) {
                ...
                // Maintain close-medium distance
                float forwardSpeed;
    ...
    public void shoot(PathfinderMob mob, LivingEntity target, InteractionHand hand, ItemStack weapon) {
        ...
        GunAiDebug.handleShoot(msg, mob, weapon, "Blazegun");
    ...
    public boolean canDualWield() {
        return false; // Blazegun cannot be dual wielded
    }
